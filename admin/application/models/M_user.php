...
class M_user extends CI_Model {
	...
	public function delete($id) {
		$sql = "DELETE FROM admin WHERE id='" .$id ."' and level<>'admin'";
	...
	public function insert_user_foto($data) {
		//var_dump($data);
		//echo json_encode($data);
		//$id = md5(DATE('ymdhms').rand());
		$pass=md5($data['password']); 
		$sql = "INSERT INTO admin VALUES('','" .$data['username'] ."','" .$pass ."','" .$data['nama'] ."','" .$data['foto'] ."','petugas')";
